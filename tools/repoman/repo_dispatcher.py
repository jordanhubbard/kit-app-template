                ...
                try:
                    ...
                    if result.returncode == 0:
                        ...
                        if "_standalone_project" in playback_data:
                            ...
                            if standalone_config.get('enabled'):
                                try:
                                    ...
                                    standalone_path = create_standalone_project(
                                        ...
                                        output_dir=Path(standalone_config['output_directory']),
                                        template_name=standalone_config['template_name'],
                        ...
                        if "_per_app_deps" in playback_data:
                            ...
                            if per_app_deps_config.get('enabled'):
                                try:
                                    ...
                                    if template_output_path.exists():
                                        ...
                                        if success:
                                            ...
                                            print(f"\n✓ Per-app dependencies initialized: {deps_path}", file=sys.stderr)
                                        else:
